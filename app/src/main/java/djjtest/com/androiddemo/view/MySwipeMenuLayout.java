...
public class MySwipeMenuLayout extends ViewGroup {
    ...
    public MySwipeMenuLayout setIos(boolean ios) {
        this.isIos = ios;
        return this;
    }
    ...
    public MySwipeMenuLayout setLeftSwipe(boolean leftSwipe) {
        this.isLeftSwipe = leftSwipe;
        return this;
    }

    public static MySwipeMenuLayout getViewCache() {
        return mViewCache;
    }
    ...
    public void smoothExpand() {
        ...
        this.mExpandAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                MySwipeMenuLayout.this.scrollTo(((Integer) animation.getAnimatedValue()).intValue(), 0);
            }
        });
        ...
        this.mExpandAnim.addListener(new AnimatorListenerAdapter() {
            public void onAnimationEnd(Animator animation) {
                MySwipeMenuLayout.this.isExpand = true;
            }
        });
    ...
    public void smoothClose() {
        ...
        this.mCloseAnim.addListener(new AnimatorListenerAdapter() {
            public void onAnimationEnd(Animator animation) {
                MySwipeMenuLayout.this.isExpand = false;
            }
        });
    ...
    public MySwipeMenuLayout setCallBack(CallBack callBack) {
