package djjtest.com.androiddemo.rv;
...
public class HorizontallyLooperLayoutManager extends RecyclerView.LayoutManager {
    private static final String TAG = "HorizontallyLooperLayoutManager";
